      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdown04">
            <a class="dropdown-item" href="/c_sport">Club sport</a>
            <a class="dropdown-item" href="/c_music">Club music</a>
            <a class="dropdown-item" href="/c_tech">Club innotech</a>
            <a class="dropdown-item" href="/c_church">Club chorale</a>
